...
function focusPlusContext(data) {
  ...
  var brush = d3.brushX().extent(arr).on("brush", brushed);
  ...
  //   small_points.plot(small_points, 1, 1);
  //   data.plot(small_points, 1, 1);
  //   plot(data, 1, 1);
  //   plot(data.features, 1, 1);
  //   plot(parseDate, 1, 1);
  //<---------------------------------------------------------------------------------------------------->
  ...
  points2.plot(selected_dots, 1, 1);
  //<---------------------------------------------------------------------------------------------------->
